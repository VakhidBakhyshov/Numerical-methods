...
double f7(double x){ return exp(-10 * x);}
...
//double f25(double x) { return (x != 0) ? sin(x) / x : 1; }
...
// sostavnaya kvadratura pryamougolnikov
...
// sostavnaya kvadratura Simpsona
